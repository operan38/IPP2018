...
class PkPks extends AdminTable
{
	public $id;
	public $name;
	...
	public function getTable()
	{
		...
		$pagination->init("SELECT COUNT(*) FROM spr_pk_pks");

		$result = $db->prepare("SELECT * FROM spr_pk_pks LIMIT :page_position,:item_per_page");
		...
		$this->getAdminList($result, $pagination, array('name'), 'id', '/admin-pk-pks/edit');
	}
	...
	public function edit()
	{
		...
		{
			$result = $db->prepare("SELECT * FROM spr_pk_pks WHERE id = :button_edit");
	...
	public function insert()
	{
		...
		$result = $db->prepare("INSERT INTO spr_pk_pks (name)
		VALUES(:name)");
	...
	public function update()
	{
		...
		if (is_numeric($edit_data_table_form_update))
		{
			...
			$result = $db->prepare("UPDATE spr_pk_pks SET name = :name WHERE id = :edit_data_table_form_update");
	...
	public function ajaxDelete()
	{
		...
		if (is_numeric($value))
		{
			$result = $db->prepare("DELETE FROM spr_pk_pks WHERE id = :value");
