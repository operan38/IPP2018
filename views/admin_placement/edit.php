<div id="edit_data_table_form">
	<form id="edit_form" method='POST' action='/admin-placement/update'>
		<p><span>Наименование</span><br>
    		<input type='text' id='edit_data_table_form_pname' name='edit_data_table_form_pname' value='<?php echo $placement->pname ?>'>
		</p><br>
