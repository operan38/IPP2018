...
<table id="main_table" class="placement_control_table">
<thead>
<tr>
  <td id="main_table_title" colspan="3"><img src="/web/images/table.png">Место размещения</td>
</tr>
<tr>
...
<div class='admin_add_table_form_fixed'>
  <form method='POST' action='/admin-placement/add'>
