<div id="admin_add_data_table_form">
	<form id="add_form" method='POST' action='/admin-omm/insert' enctype='multipart/form-data'>
		<p><span>Наименование</span><br>
    		<input type='text' id='admin_add_data_table_form_oname' name='admin_add_data_table_form_oname'>
		</p>
		<p><span></span>
			<input type='file' id='admin_add_data_table_form_uploadfile' name='admin_add_data_table_form_uploadfile'>
		</p><br>
