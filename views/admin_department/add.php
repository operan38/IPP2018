<div id="admin_add_data_table_form">
	<form id="add_form" method='POST' action='/admin-department/insert'>
		<p><span>Наименование</span><br>
    		<input type='text' id='admin_add_data_table_form_dep_name' name='admin_add_data_table_form_dep_name'>
		</p><br>
