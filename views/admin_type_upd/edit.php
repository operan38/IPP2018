<div id="edit_data_table_form">
	<form id="edit_form" method='POST' action='/admin-type-upd/update'>
		<p><span>Наименование</span><br>
    		<input type='text' id='edit_data_table_form_uname' name='edit_data_table_form_uname' value='<?php echo $typeUpd->uname ?>'>
		</p><br>
