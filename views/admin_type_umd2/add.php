<div id="admin_add_data_table_form">
	<form id="add_form" method='POST' action='/admin-type-umd2/insert'>
		<p><span>Наименование</span><br>
    		<input type='text' id='admin_add_data_table_form_name_umd2' name='admin_add_data_table_form_name_umd2'>
		</p><br>
