<div id="edit_data_table_form">
	<form id="edit_form" method='POST' action='/admin-type-participation/update'>
		<p><span>Наименование</span><br>
    		<input type='text' id='edit_data_table_form_partname' name='edit_data_table_form_partname' value='<?php echo $typeParticipation->partname ?>'>
		</p><br>
