<div id="admin_add_data_table_form">
	<form id="add_form" method='POST' action='/admin-event-nmp/insert'>
		<p><span>Наименование</span><br>
    		<input type='text' id='admin_add_data_table_form_name_event_nmp' name='admin_add_data_table_form_name_event_nmp'>
		</p><br>
