<div id="edit_data_table_form">
	<form id="edit_form" method='POST' action='/admin-type-worksew/update'>
		<p><span>Наименование</span><br>
    		<input type='text' id='edit_data_table_form_sew_name' name='edit_data_table_form_sew_name' value='<?php echo $typeWorksew->sew_name ?>'>
		</p><br>
