<div id="admin_add_data_table_form">
	<form id="add_form" method='POST' action='/admin-type-worksew/insert'>
		<p><span>Наименование</span><br>
    		<input type='text' id='admin_add_data_table_form_sew_name' name='admin_add_data_table_form_sew_name'>
		</p><br>
