<div id="admin_add_data_table_form">
	<form id="add_form" method='POST' action='/admin-type-worksmw/insert'>
		<p><span>Наименование</span><br>
    		<input type='text' id='admin_add_data_table_form_smw_name' name='admin_add_data_table_form_smw_name'>
		</p><br>
