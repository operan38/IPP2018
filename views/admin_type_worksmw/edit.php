<div id="edit_data_table_form">
	<form id="edit_form" method='POST' action='/admin-type-worksmw/update'>
		<p><span>Наименование</span><br>
    		<input type='text' id='edit_data_table_form_smw_name' name='edit_data_table_form_smw_name' value='<?php echo $typeWorksmw->smw_name ?>'>
		</p><br>
