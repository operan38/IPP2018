...
<table id="main_table" class="type_workew_control_table">
<thead>
<tr>
  <td id="main_table_title" colspan="3"><img src="/web/images/table.png">Вид деятельности ВР</td>
</tr>
<tr>
...
<div class='admin_add_table_form_fixed'>
  <form method='POST' action='/admin-type-workew/add'>
