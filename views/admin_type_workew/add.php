<div id="admin_add_data_table_form">
	<form id="add_form" method='POST' action='/admin-type-workew/insert'>
		<p><span>Наименование</span><br>
    		<input type='text' id='admin_add_data_table_form_ew_name' name='admin_add_data_table_form_ew_name'>
		</p><br>
