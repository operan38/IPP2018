<div id="admin_add_data_table_form">
	<form id="add_form" method='POST' action='/admin-index-disciplines/insert'>
		<p><span>Индекс</span><br>
    		<input type='text' id='admin_add_data_table_form_dindex' name='admin_add_data_table_form_dindex'>
		</p><br>
