...
<table id="main_table" class="index_disciplines_control_table">
<thead>
<tr>
  <td id="main_table_title" colspan="3"><img src="/web/images/table.png">Индекс дисциплин</td>
</tr>
<tr>
...
<div class='admin_add_table_form_fixed'>
  <form method='POST' action='/admin-index-disciplines/add'>
