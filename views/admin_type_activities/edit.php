<div id="edit_data_table_form">
	<form id="edit_form" method='POST' action='/admin-type-activities/update'>
		<p><span>Наименование</span><br>
    		<input type='text' id='edit_data_table_form_name' name='edit_data_table_form_name' value='<?php echo $typeActivities->name ?>'>
		</p><br>
