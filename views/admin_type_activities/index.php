...
<table id="main_table" class="type_activities_control_table">
<thead>
<tr>
  <td id="main_table_title" colspan="3"><img src="/web/images/table.png">Вид деятельности УМР/УПР</td>
</tr>
<tr>
...
<div class='admin_add_table_form_fixed'>
  <form method='POST' action='/admin-type-activities/add'>
